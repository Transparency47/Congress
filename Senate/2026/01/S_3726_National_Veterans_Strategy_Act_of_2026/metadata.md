...
- API URL: https://api.congress.gov/v3/bill/119/s/3726?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/3726
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/3726",
    "number": "3726",
  ...
  "committees": [
    {
      "activities": {
        "item": [
          {
            "date": "2026-04-29T21:37:28Z",
            "name": "Hearings By (full committee)"
          },
          {
            "date": "2026-01-29T17:00:12Z",
            "name": "Referred To"
          }
        ]
      },
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Armed Forces and National Security",
        "updateDate": "2026-02-23T17:18:12Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/s/BILLS-119s3726is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to amend title 38, United States Code, to require the President to define veteran success and to develop and implement a National Veterans Strategy, and for other purposes.",

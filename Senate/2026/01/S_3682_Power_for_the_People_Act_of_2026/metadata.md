...
- API URL: https://api.congress.gov/v3/bill/119/s/3682?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/3682
...
- Update date: 2026-04-21T18:07:20Z
- Update date including text: 2026-04-21T18:07:20Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/3682",
    "number": "3682",
    ...
    "title": "Power for the People Act of 2026",
    "type": "S",
    "updateDate": "2026-04-21T18:07:20Z",
    "updateDateIncludingText": "2026-04-21T18:07:20Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Energy",
        "updateDate": "2026-02-11T17:38:21Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/s/BILLS-119s3682is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to promote the creation of data center load queues and data center-specific rate classes to mitigate the impact of data centers on other electricity consumers, and for other purposes.",

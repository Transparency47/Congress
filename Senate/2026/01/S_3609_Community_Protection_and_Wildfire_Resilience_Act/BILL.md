...
- Congress.gov: https://www.congress.gov/bill/119th-congress/senate-bill/3609
...
- Date: 2026-01-08
- Formatted XML: https://www.govinfo.gov/bulkdata/BILLS/119/2/s/BILLS-119s3609is.xml
...
### Introduced in Senate
- Date: 2026-01-08
- Source: https://www.govinfo.gov/bulkdata/BILLS/119/2/s/BILLS-119s3609is.xml
...
January 8 (legislative day, January 7), 2026 Mr. Padilla (for himself and Mr. Sheehy ) introduced the following bill; which was read twice and referred to the Committee on Homeland Security and Governmental Affairs
A BILL
...
**(3) Community protection and wildfire resilience plan**
...
**(1) Use of grant funds**
An eligible entity that receives a grant under the program to develop a plan shall use grant funds to develop a community protection and wildfire resilience plan for the eligible entity.
**(2) Grant amounts**
...
**(B)**
methods that could be used by the Federal Government to incentivize insurance companies to accept a certification described in subparagraph (A); and
**(2)**
...
##### (b) Cooperation
In preparing the report under subsection (a), the Administrator shall coordinate with—
**(1)**
...
(D) Projects described A project referred to in paragraph (1)(B) is a project for any of the following: (i) The construction, modification, or maintenance of a structure to make the structure resistant to the intrusion of flames or embers. (ii) The modification of a structure or an area adjacent to a structure (including vegetation and miscellaneous structures, such as garages, sheds, and fencing) if such modification is carried out— (I) to reduce the exposure of the structure to direct contact from flames, radiation, or embers from wildfire; and (II) with consideration for the potential effects on the structure of nearby combustible features (including vegetation, vehicles, and miscellaneous structures, such as garages, sheds, and fencing). .
...
- 2026-01-08 - IntroReferral: Read twice and referred to the Committee on Homeland Security and Governmental Affairs.
- Latest action: 2026-01-08: Introduced in Senate

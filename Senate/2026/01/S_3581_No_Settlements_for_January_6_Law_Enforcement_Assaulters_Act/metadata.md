...
- API URL: https://api.congress.gov/v3/bill/119/s/3581?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/3581
- Title: No Settlements for January 6 Law Enforcement Assaulters Act
- Congress: 119
- Bill type: S
- Bill number: 3581
...
- 2026-01-06 - IntroReferral: Read twice and referred to the Committee on the Judiciary.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/3581",
    "number": "3581",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Crime and Law Enforcement",
        "updateDate": "2026-01-26T14:38:34Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/s/BILLS-119s3581is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to prohibit the payment of certain legal settlements to any individual convicted of assaulting a law enforcement officer in connection with breaching the Capitol on January 6, 2021.",
      "titleType": "Official Title as Introduced",
      "titleTypeCode": "6",
      "updateDate": "2026-01-24T03:48:19Z"
    }
  ]
}
```

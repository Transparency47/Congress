...
- Congress.gov: https://www.congress.gov/bill/119th-congress/senate-bill/4144
...
- Date: 2026-03-19
- Formatted XML: https://www.govinfo.gov/bulkdata/BILLS/119/2/s/BILLS-119s4144is.xml
...
### Introduced in Senate
- Date: 2026-03-19
- Source: https://www.govinfo.gov/bulkdata/BILLS/119/2/s/BILLS-119s4144is.xml
...
March 19, 2026 Mr. Coons (for himself and Ms. Murkowski ) introduced the following bill; which was read twice and referred to the Committee on Banking, Housing, and Urban Affairs
A BILL
...
in subparagraph (B)—
**(A)**
in the matter preceding clause (i), by inserting an entity or individual that is, in good faith and not for the purpose of evading this title after include ;
**(B)**
...
**(A)**
in the matter preceding subparagraph (A), by inserting knowingly before make any statement, or ;
**(B)**
...
in subsection (a)(2)—
**(A)**
in subparagraph (B)(ii), by striking the semicolon and inserting ; or ; and
**(B)**
by adding at the end the following:
...
**(A)**
in the second undesignated paragraph, by inserting Credit repair organizations do not provide any services that you cannot do yourself for free. after the period at the end of the fourth sentence;
**(B)**
in the eighth undesignated paragraph, by striking regulates and inserting and the Bureau of Consumer Financial Protection regulate ; and
**(C)**
...
in subsection (c)—
**(A)**
in paragraph (1), by inserting and any recordings of telephone communications with the consumer before the period at the end; and
**(B)**
in paragraph (2)—
**(i)**
in the heading, by striking 2 and inserting 5 ;
**(ii)**
...
##### (a) In general
The Credit Repair Organizations Act ( 15 U.S.C. 1679 et seq. ) is amended by inserting after section 408 the following:
...
**(1)**
in the heading, by striking Actual damages and inserting Damages ;
**(2)**
...
**(4)**
by adding at the end the following:
(C) damages of $500 for each violation of this title. .

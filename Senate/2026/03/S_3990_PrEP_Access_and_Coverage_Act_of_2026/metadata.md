...
- API URL: https://api.congress.gov/v3/bill/119/s/3990?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/3990
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/3990",
    "number": "3990",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2026-03-23T20:36:52Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/s/BILLS-119s3990is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to increase access to pre-exposure prophylaxis to reduce the transmission of HIV.",

...
- API URL: https://api.congress.gov/v3/bill/119/s/4068?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/4068
...
- 2026-03-12 - IntroReferral: Read twice and referred to the Committee on Finance. (Sponsor introductory remarks on measure: CR S1048-1049)
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/4068",
    "number": "4068",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Labor and Employment",
        "updateDate": "2026-04-21T19:19:51Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/s/BILLS-119s4068is.xml"
        }
      ],
  ...
  "titles": [
    {
      ...
      "title": "A bill to establish an AmeriCorps Administration to carry out the national and volunteer service programs, to expand participation in such programs, and for other purposes.",

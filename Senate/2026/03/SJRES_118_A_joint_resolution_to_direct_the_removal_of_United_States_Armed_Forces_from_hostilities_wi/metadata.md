...
- API URL: https://api.congress.gov/v3/bill/119/sjres/118?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-joint-resolution/118
...
- Update date: 2026-05-06T20:30:23Z
- Update date including text: 2026-05-06T20:30:23Z
...
- 2026-03-18 - Discharge: Motion to discharge Senate Committee on Foreign Relations rejected by Yea-Nay Vote. 47 - 53. Record Vote Number: 58.
  - Recorded vote: Senate session 2, roll 58 (2026-03-18T23:52:57Z)
...
- Vote: Senate session 2, roll 58, date 2026-03-18T23:52:57Z
  - Result: Motion to Discharge Rejected (47-53)
  - Question: On the Motion to Discharge S.J.Res. 118
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-joint-resolution/118",
    "number": "118",
    ...
    "title": "A joint resolution to direct the removal of United States Armed Forces from hostilities within or against the Islamic Republic of Iran that have not been authorized by Congress.",
    "type": "SJRES",
    "updateDate": "2026-05-06T20:30:23Z",
    "updateDateIncludingText": "2026-05-06T20:30:23Z"
  }
}
```
      ...
      "recordedVotes": [
        {
          "chamber": "Senate",
          "congress": "119",
          "date": "2026-03-18T23:52:57Z",
          "rollNumber": "58",
          "sessionNumber": "2",
          "url": "https://www.senate.gov/legislative/LIS/roll_call_votes/vote1192/vote_119_2_00058.xml"
        }
      ],
      "sourceSystem": {
        "name": "Senate"
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "International Affairs",
        "updateDate": "2026-03-09T22:53:14Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/sjres/BILLSUM-119sjres118.xml",
    "summary": {
      "actionDate": "2026-03-05",
      "actionDesc": "Introduced in Senate",
      "text": "<p>This joint resolution directs the President to remove U.S. Armed Forces from hostilities within or against Iran unless a declaration of war or authorization to use military force for such purpose has been enacted.</p><p>The resolution specifies that it shall not be construed to prevent the United States from defending against an attack on the United States or its personnel or facilities in other nations.</p>",
      "updateDate": "2026-04-27",
      "versionCode": "id119sjres118"
    },
    "title": "A joint resolution to direct the removal of United States Armed Forces from hostilities within or against the Islamic Republic of Iran that have not been authorized by Congress."
  },
  "summaries": [
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/sjres/BILLS-119sjres118is.xml"
        }
      ],
      "type": "IS"
    }
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "45",
      "updateDate": "2026-03-06T11:56:20Z"
    }
  ]
}
```
  ...
  "votes": [
    {
      ...
      "detail": {
        "senateRollCallVote": {
          ...
          "result": "Motion to Discharge Rejected (47-53)",
          "voteDate": "March 18, 2026, 07:07 PM",
          "voteQuestion": "On the Motion to Discharge S.J.Res. 118",
          "voteTitle": "Motion to Discharge S.J.Res. 118",
      ...
      "sourcePayload": {
        ...
        "modify_date": "March 18, 2026, 08:05 PM",
        ...
        "vote_date": "March 18, 2026, 07:07 PM",
        ...
        "vote_number": "58",
        "vote_question_text": "On the Motion to Discharge S.J.Res. 118",
        "vote_result": "Motion to Discharge Rejected",
        "vote_result_text": "Motion to Discharge Rejected (47-53)",
        "vote_title": "Motion to Discharge S.J.Res. 118"
      },
      "sourceUrl": "https://www.senate.gov/legislative/LIS/roll_call_votes/vote1192/vote_119_2_00058.xml"
    }
  ]
}
```

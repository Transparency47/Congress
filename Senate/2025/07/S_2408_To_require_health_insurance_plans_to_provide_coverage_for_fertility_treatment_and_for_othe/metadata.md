...
- API URL: https://api.congress.gov/v3/bill/119/s/2408?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/2408
- Title: Access to Fertility Treatment and Care Act
- Congress: 119
- Bill type: S
- Bill number: 2408
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/2408",
    "number": "2408",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2025-09-16T15:13:47Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s2408is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to require health insurance plans to provide coverage for fertility treatment, and for other purposes.",

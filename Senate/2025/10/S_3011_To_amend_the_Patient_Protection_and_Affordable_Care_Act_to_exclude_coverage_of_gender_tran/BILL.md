...
- Congress.gov: https://www.congress.gov/bill/119th-congress/senate-bill/3011
...
- Date: 2025-10-15
- Formatted XML: https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s3011is.xml
...
### Introduced in Senate
- Date: 2025-10-15
- Source: https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s3011is.xml
...
October 15, 2025 Mr. Hawley introduced the following bill; which was read twice and referred to the Committee on Health, Education, Labor, and Pensions
A BILL
...
**(B)**
by striking the subsection designation and heading and all that follows through A State in paragraph (1) and inserting the following:
(a) State opt-Out of abortion coverage A State ;
**(2)**
in subsection (b), by striking the subsection designation and heading and all that follows through No qualified in paragraph (4) and inserting the following:
...
in paragraph (2)—
**(i)**
by striking the paragraph designation and heading and all that follows through Nothing in subparagraph (A) and inserting the following:
(2) No effect on Federal laws regarding abortion Nothing ; and
**(ii)**
by redesignating clauses (i) through (iii) as subparagraphs (A) through (C), respectively, and adjusting the margins accordingly;
**(B)**

...
- API URL: https://api.congress.gov/v3/bill/119/s/1283?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/1283
- Title: Innovate to De-Escalate Modernization Act
- Congress: 119
- Bill type: S
- Bill number: 1283
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/1283",
    "number": "1283",
  ...
  "subjects": [
    {
        ...
        "item": [
          {
            ...
            "updateDate": "2025-11-24T21:44:41Z"
          },
          {
      ...
      "policyArea": {
        "name": "Crime and Law Enforcement",
        "updateDate": "2025-05-02T15:10:06Z"
      }
    }
  ]
}
      ...
      "item": {
        ...
        "summary": {
          "@attributes": {
            ...
            "summary-id": "id119s1283v00",
            "update-date": "2026-04-06"
          },
          "action-date": "2025-04-03",
          "action-desc": "Introduced in Senate",
          "summary-text": "<p><strong>Innovate to De-Escalate Modernization Act</strong></p><p>This bill removes less-than-lethal projectile devices (e.g., certain TASERs) from regulation under the Gun Control Act.</p><p>The term <em>less-than-lethal projectile device</em> means a device that (1) is not designed or intended to expel (and may not be readily converted to discharge) commonly used ammunition or projectiles exceeding a velocity of 500 feet per second; (2) is designed and intended to be used in a manner not likely to cause death or serious bodily injury; and (3) does not accept (and cannot be readily modified to accept) an ammunition feeding device.</p><p>The bill also requires the Bureau of Alcohol, Tobacco, Firearms and Explosives to determine whether a device satisfies the definition of a <em>less-than-lethal projectile device</em> within 90 days of a request.</p>"
        },
        "title": "Innovate to De-Escalate Modernization Act"
      }
    },
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/s/BILLSUM-119s1283.xml",
    "summary": {
      "actionDate": "2025-04-03",
      "actionDesc": "Introduced in Senate",
      "text": "<p><strong>Innovate to De-Escalate Modernization Act</strong></p><p>This bill removes less-than-lethal projectile devices (e.g., certain TASERs) from regulation under the Gun Control Act.</p><p>The term <em>less-than-lethal projectile device</em> means a device that (1) is not designed or intended to expel (and may not be readily converted to discharge) commonly used ammunition or projectiles exceeding a velocity of 500 feet per second; (2) is designed and intended to be used in a manner not likely to cause death or serious bodily injury; and (3) does not accept (and cannot be readily modified to accept) an ammunition feeding device.</p><p>The bill also requires the Bureau of Alcohol, Tobacco, Firearms and Explosives to determine whether a device satisfies the definition of a <em>less-than-lethal projectile device</em> within 90 days of a request.</p>",
      "updateDate": "2026-04-06",
      "versionCode": "id119s1283"
    },
    "title": "Innovate to De-Escalate Modernization Act"
  },
  "summaries": [
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s1283is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to modernize Federal firearms laws to account for advancements in technology and less-than-lethal weapons, and for other purposes.",

...
- API URL: https://api.congress.gov/v3/bill/119/s/1287?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/1287
- Title: DELETE Act
- Congress: 119
- Bill type: S
- Bill number: 1287
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/1287",
    "number": "1287",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Commerce",
        "updateDate": "2025-05-19T19:50:29Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s1287is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to establish a centralized system to allow individuals to request the simultaneous deletion of their personal information across all data brokers, and for other purposes.",

...
- API URL: https://api.congress.gov/v3/bill/119/s/2062?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/2062
...
- Update date: 2026-01-14T05:02:29Z
- Update date including text: 2026-01-14T05:02:29Z
...
- 2025-06-12 - IntroReferral: Read twice and referred to the Committee on Health, Education, Labor, and Pensions.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/2062",
    "number": "2062",
    ...
    "title": "RAPID Reserve Act",
    "type": "S",
    "updateDate": "2026-01-14T05:02:29Z",
    "updateDateIncludingText": "2026-01-14T05:02:29Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2025-07-14T15:29:55Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s2062is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to improve supply chain resiliency for critical drug products with vulnerable supply chains and ensure that reserves of critical drugs and active pharmaceutical ingredients are maintained to prevent supply disruptions in the event of drug shortages or public health emergencies.",

...
- API URL: https://api.congress.gov/v3/bill/119/s/3421?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/3421
...
- Update date: 2026-01-07T17:51:14Z
- Update date including text: 2026-01-07T17:51:14Z
...
- 2025-12-10 - IntroReferral: Read twice and referred to the Committee on Health, Education, Labor, and Pensions. (text: CR S8625)
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/3421",
    "number": "3421",
    ...
    "title": "Medical Device Recall Improvement Act of 2025",
    "type": "S",
    "updateDate": "2026-01-07T17:51:14Z",
    "updateDateIncludingText": "2026-01-07T17:51:14Z"
  }
}
```
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s3421is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to improve medical device recall notifications by amending the Federal Food, Drug, and Cosmetic Act to establish an electronic format for device recall notifications, and for other purposes.",

...
- API URL: https://api.congress.gov/v3/bill/119/s/3446?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/3446
- Title: A bill to require the Secretary of Defense to submit a strategy to accelerate the response efforts of the Department of Defense with respect to releases of perfluoroalkyl substances or polyfluoroalkyl substances from the activities of the Department.
- Congress: 119
- Bill type: S
- Bill number: 3446
- Origin chamber: Senate
- Introduced date: 2025-12-11
- Update date: 2026-01-12T18:50:13Z
- Update date including text: 2026-01-12T18:50:13Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/3446",
    "number": "3446",
    ...
    "title": "A bill to require the Secretary of Defense to submit a strategy to accelerate the response efforts of the Department of Defense with respect to releases of perfluoroalkyl substances or polyfluoroalkyl substances from the activities of the Department.",
    "type": "S",
    "updateDate": "2026-01-12T18:50:13Z",
    "updateDateIncludingText": "2026-01-12T18:50:13Z"
  }
}
```
  ...
  "fullTexts": [
    {
      ...
      "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s3446is.xml",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Armed Forces and National Security",
        "updateDate": "2026-01-06T19:46:29Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s3446is.xml"
        }
      ],
  ...
  "titles": [
    {
      ...
      "titleTypeCode": "6",
      "updateDate": "2026-01-06T06:18:28Z"
    },
    {
      "title": "A bill to require the Secretary of Defense to submit a strategy to accelerate the response efforts of the Department of Defense with respect to releases of perfluoroalkyl substances or polyfluoroalkyl substances from the activities of the Department.",
      "titleType": "Display Title",
      "titleTypeCode": "45",
      "updateDate": "2025-12-12T11:56:28Z"
    }
  ]
}
```

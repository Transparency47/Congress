...
- API URL: https://api.congress.gov/v3/bill/119/s/3365?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/3365
...
- Update date: 2026-03-11T15:36:50Z
- Update date including text: 2026-03-11T15:36:50Z
...
- 2025-12-04 - IntroReferral: Read twice and referred to the Committee on Health, Education, Labor, and Pensions. (Sponsor introductory remarks on measure: CR S8513-8514)
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/3365",
    "number": "3365",
    ...
    "title": "Right to Read Act of 2025",
    "type": "S",
    "updateDate": "2026-03-11T15:36:50Z",
    "updateDateIncludingText": "2026-03-11T15:36:50Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Education",
        "updateDate": "2026-01-06T15:37:21Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/s/BILLSUM-119s3365.xml",
    "summary": {
      "actionDate": "2025-12-04",
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s3365is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to ensure that students in schools have a right to read, and for other purposes.",
      "titleType": "Official Title as Introduced",
      "titleTypeCode": "6",
      "updateDate": "2025-12-30T05:33:19Z"
    }
  ]
}
```

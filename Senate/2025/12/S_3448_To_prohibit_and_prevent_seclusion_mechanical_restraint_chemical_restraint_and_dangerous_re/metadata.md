...
- API URL: https://api.congress.gov/v3/bill/119/s/3448?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/3448
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/3448",
    "number": "3448",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Education",
        "updateDate": "2026-01-12T16:45:42Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s3448is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to prohibit and prevent seclusion, mechanical restraint, chemical restraint, and dangerous restraints that restrict breathing, and to prevent and reduce the use of physical restraint in schools, and for other purposes.",

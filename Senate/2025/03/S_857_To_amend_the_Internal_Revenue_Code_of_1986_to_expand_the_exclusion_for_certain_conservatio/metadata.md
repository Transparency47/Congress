...
- API URL: https://api.congress.gov/v3/bill/119/s/857?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/857
...
- 2025-03-05 - IntroReferral: Read twice and referred to the Committee on Finance.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/857",
    "number": "857",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Taxation",
        "updateDate": "2025-05-08T18:48:37Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s857is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to amend the Internal Revenue Code of 1986 to expand the exclusion for certain conservation subsidies to include subsidies for water conservation or efficiency measures, storm water management measures, and wastewater management measures.",

...
- API URL: https://api.congress.gov/v3/bill/119/s/925?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/925
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/925",
    "number": "925",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Taxation",
        "updateDate": "2025-05-08T19:06:04Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s925is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to amend the Internal Revenue Code of 1986 to provide a tax credit for working family caregivers.",

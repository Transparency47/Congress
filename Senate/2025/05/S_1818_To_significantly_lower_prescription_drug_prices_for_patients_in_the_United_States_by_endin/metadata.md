...
- API URL: https://api.congress.gov/v3/bill/119/s/1818?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/1818
...
- Update date: 2026-03-24T15:56:34Z
- Update date including text: 2026-03-24T15:56:34Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/1818",
    "number": "1818",
    ...
    "title": "Prescription Drug Price Relief Act of 2025",
    "type": "S",
    "updateDate": "2026-03-24T15:56:34Z",
    "updateDateIncludingText": "2026-03-24T15:56:34Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2025-05-30T14:04:21Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/s/BILLSUM-119s1818.xml",
    "summary": {
      "actionDate": "2025-05-20",
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s1818is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to significantly lower prescription drug prices for patients in the United States by ending government-granted monopolies for manufacturers who charge drug prices that are higher than the median prices at which the drugs are available in other countries.",

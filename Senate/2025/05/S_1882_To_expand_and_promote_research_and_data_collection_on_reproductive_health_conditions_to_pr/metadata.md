...
- API URL: https://api.congress.gov/v3/bill/119/s/1882?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/senate-bill/1882
- Title: RESTORE Act
- Congress: 119
- Bill type: S
- Bill number: 1882
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/senate-bill/1882",
    "number": "1882",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2025-06-25T10:52:29Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/s/BILLS-119s1882is.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IS",
      "billTextVersionName": "Introduced in Senate",
      "title": "A bill to expand and promote research and data collection on reproductive health conditions, to provide training opportunities for medical professionals to learn how to diagnose and treat reproductive health conditions, and for other purposes.",

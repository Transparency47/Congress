...
- API URL: https://api.congress.gov/v3/bill/119/hr/3996?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/3996
...
- Update date: 2025-12-05T22:04:59Z
- Update date including text: 2025-12-05T22:04:59Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/3996",
    "number": "3996",
    "originChamber": "House",
    "policyArea": {
      "name": "Health"
    ...
    "title": "Medicare Transaction Fraud Prevention Act",
    "type": "HR",
    "updateDate": "2025-12-05T22:04:59Z",
    "updateDateIncludingText": "2025-12-05T22:04:59Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2025-09-18T19:34:33Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr3996ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To amend title XI of the Social Security Act to establish a pilot program for testing the use of a predictive risk-scoring algorithm to provide oversight of payments for durable medical equipment and clinical diagnostic laboratory tests under the Medicare program.",
      "titleType": "Official Title as Introduced",
      "titleTypeCode": "6",
      "updateDate": "2025-08-14T03:18:16Z"
    }
  ]
}
```

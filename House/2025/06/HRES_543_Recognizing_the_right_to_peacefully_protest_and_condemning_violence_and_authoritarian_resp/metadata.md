...
- API URL: https://api.congress.gov/v3/bill/119/hres/543?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-resolution/543
- Title: Recognizing the right to peacefully protest and condemning violence and authoritarian responses to expressions of dissent.
- Congress: 119
- Bill type: HRES
- Bill number: 543
...
- 2025-06-25 - IntroReferral: Referred to the Committee on the Judiciary, and in addition to the Committee on Armed Services, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-06-25 - IntroReferral: Referred to the Committee on the Judiciary, and in addition to the Committee on Armed Services, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-06-25 - IntroReferral: Submitted in House
- 2025-06-25 - IntroReferral: Submitted in House
- 2025-06-27 - IntroReferral: Sponsor introductory remarks on measure. (CR H3021-3022)
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-resolution/543",
    "number": "543",
    "originChamber": "House",
    "policyArea": {
  ...
  "actions": [
    {
      ...
      "text": "Sponsor introductory remarks on measure. (CR H3021-3022)",
      "type": "IntroReferral"
    },
    {
      "actionCode": "H11100",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Civil Rights and Liberties, Minority Issues",
        "updateDate": "2025-08-18T17:13:42Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hres/BILLS-119hres543ih.xml"
        }
      ],
      "type": "IH"
    }
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "45",
      "updateDate": "2025-06-26T08:06:00Z"
    }
  ]
}
```

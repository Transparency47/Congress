...
- API URL: https://api.congress.gov/v3/bill/119/hr/4266?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/4266
- Title: Housing for US Act
- Congress: 119
- Bill type: HR
- Bill number: 4266
...
- 2025-06-30 - IntroReferral: Introduced in House
- 2025-06-30 - IntroReferral: Referred to the House Committee on Financial Services.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/4266",
    "number": "4266",
    "originChamber": "House",
    "policyArea": {
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Housing and Community Development",
        "updateDate": "2025-09-18T12:23:46Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr4266ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To require that any amounts received by the Federal Government as a result of the release of the Federal National Mortgage Association and the Federal Home Loan Mortgage Corporation be used for State housing revolving loan funds for middle-class housing supply, and for other purposes.",

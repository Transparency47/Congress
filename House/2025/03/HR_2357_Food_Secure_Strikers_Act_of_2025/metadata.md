...
- API URL: https://api.congress.gov/v3/bill/119/hr/2357?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/2357
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/2357",
    "number": "2357",
    "originChamber": "House",
    "policyArea": {
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Agriculture and Food",
        "updateDate": "2025-05-06T17:33:50Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hr/BILLSUM-119hr2357.xml",
    "summary": {
      "actionDate": "2025-03-26",
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr2357ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To amend the Food and Nutrition Act of 2008 to ensure that striking workers and their households do not become ineligible for benefits under the supplemental nutrition assistance program, and for other purposes.",

...
- API URL: https://api.congress.gov/v3/bill/119/hr/2477?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/2477
...
- 2025-03-27 - IntroReferral: Introduced in House
- 2025-03-27 - IntroReferral: Referred to the Committee on Energy and Commerce, and in addition to the Committee on Ways and Means, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-03-27 - IntroReferral: Referred to the Committee on Energy and Commerce, and in addition to the Committee on Ways and Means, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/2477",
    "number": "2477",
    "originChamber": "House",
    "policyArea": {
      "name": "Health"
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2025-04-07T13:11:09Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hr/BILLSUM-119hr2477.xml",
    "summary": {
      "actionDate": "2025-03-27",
      "actionDesc": "Introduced in House",
      "text": "<p><strong>Portable Ultrasound Reimbursement Equity Act of 2025</strong></p><p>This bill provides for Medicare coverage of ultrasound tests performed\u00a0at a beneficiary's home. The Centers for Medicare & Medicaid Services must provide for separate payments for portable ultrasound services in the same manner and to the same extent as for portable X-ray services.</p>",
      "updateDate": "2026-04-14",
      "versionCode": "id119hr2477"
    },
    "title": "Portable Ultrasound Reimbursement Equity Act of 2025"
  },
  "summaries": [
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr2477ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To amend title XVIII of the Social Security Act to provide coverage of portable ultrasound transportation and set up services under the Medicare program.",
      "titleType": "Official Title as Introduced",
      "titleTypeCode": "6",
      "updateDate": "2025-04-06T04:33:35Z"
    }
  ]
}
```

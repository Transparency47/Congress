...
- API URL: https://api.congress.gov/v3/bill/119/hr/2213?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/2213
...
- Update date: 2026-02-05T09:06:06Z
- Update date including text: 2026-02-05T09:06:06Z
...
- 2025-03-18 - IntroReferral: Introduced in House
- 2025-03-18 - IntroReferral: Referred to the Committee on Ways and Means, and in addition to the Committee on Rules, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-03-18 - IntroReferral: Referred to the Committee on Ways and Means, and in addition to the Committee on Rules, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/2213",
    "number": "2213",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Medical Supply Chain Resiliency Act",
    "type": "HR",
    "updateDate": "2026-02-05T09:06:06Z",
    "updateDateIncludingText": "2026-02-05T09:06:06Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Foreign Trade and International Finance",
        "updateDate": "2025-05-21T14:13:19Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hr/BILLSUM-119hr2213.xml",
    "summary": {
      "actionDate": "2025-03-18",
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr2213ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To authorize the President to enter into trade agreements for the reciprocal elimination of duties or other import restrictions with respect to medical goods to contribute to the national security and public health of the United States, and for other purposes.",

...
- API URL: https://api.congress.gov/v3/bill/119/hr/271?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/271
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/271",
    "number": "271",
    "originChamber": "House",
    "policyArea": {
      "name": "Health"
  ...
  "subjects": [
    {
      "legislativeSubjects": {
        "item": [
          {
            "name": "Abortion",
            "updateDate": "2025-02-10T19:03:29Z"
          },
          {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2025-02-06T19:51:41Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr271ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To provide for a moratorium on Federal funding to Planned Parenthood Federation of America, Inc.",

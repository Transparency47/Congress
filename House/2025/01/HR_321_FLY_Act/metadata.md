...
- API URL: https://api.congress.gov/v3/bill/119/hr/321?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/hr/321
- Title: FLY Act
- Congress: 119
- Bill type: HR
- Bill number: 321
...
- Update date: 2025-02-12T14:34:19Z
- Update date including text: 2025-02-12T14:34:19Z
...
- 2025-01-09 - IntroReferral: Introduced in House
- 2025-01-09 - IntroReferral: Referred to the Committee on Transportation and Infrastructure, and in addition to the Committee on Homeland Security, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-01-09 - IntroReferral: Referred to the Committee on Transportation and Infrastructure, and in addition to the Committee on Homeland Security, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-01-09 - Committee: Referred to the Subcommittee on Transportation and Maritime Security.
- 2025-01-10 - Committee: Referred to the Subcommittee on Aviation.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/hr/321",
    "number": "321",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "FLY Act",
    "type": "HR",
    "updateDate": "2025-02-12T14:34:19Z",
    "updateDateIncludingText": "2025-02-12T14:34:19Z"
  }
}
```
  ...
  "fullTexts": [
    {
      ...
      "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr321ih.xml",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Transportation and Public Works",
        "updateDate": "2025-02-10T15:44:33Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr321ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "Fast Lane for Youths Act",
      "titleType": "Short Title(s) as Introduced",
      "titleTypeCode": "101",
      "updateDate": "2025-02-08T09:08:19Z"
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To establish a system to expedite gate passes and flight access procedures to allow caregivers, parents, and guardians to accompany minors and passengers needing assistance to their flights.",
      "titleType": "Official Title as Introduced",
      "titleTypeCode": "6",
      "updateDate": "2025-02-08T09:03:20Z"
    }
  ]
}
```

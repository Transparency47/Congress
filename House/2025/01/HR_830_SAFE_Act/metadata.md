...
- API URL: https://api.congress.gov/v3/bill/119/hr/830?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/830
- Title: SAFE Act
- Congress: 119
- Bill type: HR
- Bill number: 830
...
- 2025-01-31 - IntroReferral: Introduced in House
- 2025-01-31 - IntroReferral: Referred to the Committee on Energy and Commerce, and in addition to the Committee on the Judiciary, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-01-31 - IntroReferral: Referred to the Committee on Energy and Commerce, and in addition to the Committee on the Judiciary, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/830",
    "number": "830",
    "originChamber": "House",
    "policyArea": {
  ...
  "subjects": [
    {
        ...
        "item": [
          {
            ...
            "updateDate": "2025-04-04T20:14:54Z"
          },
          {
      ...
      "policyArea": {
        "name": "Crime and Law Enforcement",
        "updateDate": "2025-03-03T17:25:24Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr830ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "Save Americans from the Fentanyl Emergency Act",
      "titleType": "Short Title(s) as Introduced",
      "titleTypeCode": "101",
      "updateDate": "2025-02-28T03:53:20Z"
    },

...
- API URL: https://api.congress.gov/v3/bill/119/hr/4685?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/4685
- Title: ICBM Act
- Congress: 119
- Bill type: HR
- Bill number: 4685
...
- Update date: 2025-12-05T22:48:02Z
- Update date including text: 2025-12-05T22:48:02Z
...
- 2025-07-23 - IntroReferral: Introduced in House
- 2025-07-23 - IntroReferral: Referred to the Committee on Armed Services, and in addition to the Committee on Appropriations, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-07-23 - IntroReferral: Referred to the Committee on Armed Services, and in addition to the Committee on Appropriations, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/4685",
    "number": "4685",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "ICBM Act",
    "type": "HR",
    "updateDate": "2025-12-05T22:48:02Z",
    "updateDateIncludingText": "2025-12-05T22:48:02Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Armed Forces and National Security",
        "updateDate": "2025-09-19T17:31:08Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr4685ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To pause development of the new Sentinel program, extend the life of the Minuteman III, and redirect savings from Sentinel toward the Department of Education, and for other purposes.",
      "titleType": "Official Title as Introduced",
      "titleTypeCode": "6",
      "updateDate": "2025-08-08T04:48:34Z"
    }
  ]
}
```

...
- API URL: https://api.congress.gov/v3/bill/119/hr/4738?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/4738
- Title: Baby Safety Tax Relief Act
- Congress: 119
- Bill type: HR
- Bill number: 4738
- Origin chamber: House
- Introduced date: 2025-07-23
- Update date: 2026-05-04T17:03:01Z
- Update date including text: 2026-05-04T17:03:01Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/4738",
    "number": "4738",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Baby Safety Tax Relief Act",
    "type": "HR",
    "updateDate": "2026-05-04T17:03:01Z",
    "updateDateIncludingText": "2026-05-04T17:03:01Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Foreign Trade and International Finance",
        "updateDate": "2025-08-06T16:48:04Z"
      }
    }
  ]
}
      ...
      "item": {
        ...
        "summary": {
          "@attributes": {
            ...
            "summary-id": "id119hr4738v00",
            "update-date": "2026-05-04"
          },
          "action-date": "2025-07-23",
          "action-desc": "Introduced in House",
          "summary-text": "<p><strong>Baby Safety Tax Relief Act</strong></p><p>This bill prohibits the imposition of duties (i.e., tariffs) on specified baby safety items (i.e., baby carriages, strollers, carriers, and car seats) pursuant to certain presidential powers.</p><p>Specifically, the bill\u00a0prohibits the President from exercising authorities under the International Emergency Economic Powers Act (IEEPA) to impose duties on specified baby safety items entering the United States. (IEEPA provides the President with broad authority to regulate various economic transactions following a declaration of a national emergency.)</p><p>Further, the President must terminate the duties on these items that were imposed pursuant to IEEPA and are in effect as of the date of the bill's enactment.</p><p>The bill also prohibits the President from using any other authorities to impose duties on these items that are substantially similar to the duties imposed pursuant to IEEPA.</p>"
        },
        "title": "Baby Safety Tax Relief Act"
      }
    },
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hr/BILLSUM-119hr4738.xml",
    "summary": {
      "actionDate": "2025-07-23",
      "actionDesc": "Introduced in House",
      "text": "<p><strong>Baby Safety Tax Relief Act</strong></p><p>This bill prohibits the imposition of duties (i.e., tariffs) on specified baby safety items (i.e., baby carriages, strollers, carriers, and car seats) pursuant to certain presidential powers.</p><p>Specifically, the bill\u00a0prohibits the President from exercising authorities under the International Emergency Economic Powers Act (IEEPA) to impose duties on specified baby safety items entering the United States. (IEEPA provides the President with broad authority to regulate various economic transactions following a declaration of a national emergency.)</p><p>Further, the President must terminate the duties on these items that were imposed pursuant to IEEPA and are in effect as of the date of the bill's enactment.</p><p>The bill also prohibits the President from using any other authorities to impose duties on these items that are substantially similar to the duties imposed pursuant to IEEPA.</p>",
      "updateDate": "2026-05-04",
      "versionCode": "id119hr4738"
    },
    "title": "Baby Safety Tax Relief Act"
  },
  "summaries": [
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr4738ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To prohibit the imposition of duties on certain baby safety items pursuant to the International Emergency Economic Powers Act, and for other purposes.",
      "titleType": "Official Title as Introduced",
      "titleTypeCode": "6",
      "updateDate": "2025-08-05T05:03:49Z"
    }
  ]
}
```

...
- API URL: https://api.congress.gov/v3/bill/119/hr/3175?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/hr/3175
- Title: To authorize the President to award the Medal of Honor to Thomas H. Griffin for acts of valor as a member of the Army during the Vietnam War.
- Congress: 119
- Bill type: HR
- Bill number: 3175
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/hr/3175",
    "number": "3175",
    "originChamber": "House",
    "policyArea": {
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Armed Forces and National Security",
        "updateDate": "2025-06-04T13:18:19Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr3175ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "45",
      "updateDate": "2025-05-02T08:06:36Z"
    }
  ]
}
```

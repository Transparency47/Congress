...
- API URL: https://api.congress.gov/v3/bill/119/hjres/47?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-joint-resolution/47
- Title: Providing for congressional disapproval under chapter 8 of title 5, United States Code, of the rule submitted by the Office of the Comptroller of the Currency relating to "Quality Control Standards for Automated Valuation Models".
- Congress: 119
- Bill type: HJRES
- Bill number: 47
- Origin chamber: House
- Introduced date: 2025-02-12
- Update date: 2026-04-06T21:18:49Z
- Update date including text: 2026-04-06T21:18:49Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-joint-resolution/47",
    "number": "47",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Providing for congressional disapproval under chapter 8 of title 5, United States Code, of the rule submitted by the Office of the Comptroller of the Currency relating to \"Quality Control Standards for Automated Valuation Models\".",
    "type": "HJRES",
    "updateDate": "2026-04-06T21:18:49Z",
    "updateDateIncludingText": "2026-04-06T21:18:49Z"
  }
}
```
  ...
  "fullTexts": [
    {
      ...
      "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hjres/BILLS-119hjres47ih.xml",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Finance and Financial Sector",
        "updateDate": "2025-02-14T15:15:12Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hjres/BILLSUM-119hjres47.xml",
    "summary": {
      "actionDate": "2025-02-12",
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hjres/BILLS-119hjres47ih.xml"
        }
      ],
      "type": "IH"
    }
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "45",
      "updateDate": "2025-02-13T09:05:53Z"
    }
  ]
}
```

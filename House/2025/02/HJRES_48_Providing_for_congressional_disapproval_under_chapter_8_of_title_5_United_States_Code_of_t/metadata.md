...
- API URL: https://api.congress.gov/v3/bill/119/hjres/48?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-joint-resolution/48
- Title: Providing for congressional disapproval under chapter 8 of title 5, United States Code, of the rule submitted by the Board of Governors of the Federal Reserve System relating to "Quality Control Standards for Automated Valuation Models".
- Congress: 119
- Bill type: HJRES
- Bill number: 48
- Origin chamber: House
- Introduced date: 2025-02-12
- Update date: 2026-04-06T21:19:43Z
- Update date including text: 2026-04-06T21:19:43Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-joint-resolution/48",
    "number": "48",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Providing for congressional disapproval under chapter 8 of title 5, United States Code, of the rule submitted by the Board of Governors of the Federal Reserve System relating to \"Quality Control Standards for Automated Valuation Models\".",
    "type": "HJRES",
    "updateDate": "2026-04-06T21:19:43Z",
    "updateDateIncludingText": "2026-04-06T21:19:43Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Finance and Financial Sector",
        "updateDate": "2025-02-14T15:18:27Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hjres/BILLSUM-119hjres48.xml",
    "summary": {
      "actionDate": "2025-02-12",
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hjres/BILLS-119hjres48ih.xml"
        }
      ],
      "type": "IH"
    }
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "45",
      "updateDate": "2025-02-13T09:06:43Z"
    }
  ]
}
```

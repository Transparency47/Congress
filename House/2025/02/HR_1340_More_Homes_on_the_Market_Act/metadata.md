...
- API URL: https://api.congress.gov/v3/bill/119/hr/1340?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/1340
...
- Update date: 2026-05-21T08:07:55Z
- Update date including text: 2026-05-21T08:07:55Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/1340",
    "number": "1340",
    "originChamber": "House",
    "policyArea": {
      "name": "Taxation"
    ...
    "updateDateIncludingText": "2026-05-21T08:07:55Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Taxation",
        "updateDate": "2025-05-06T14:12:07Z"
      }
    }
  ]
}
      ...
      "item": {
        ...
        "summary": {
          "@attributes": {
            ...
            "summary-id": "id119hr1340v00",
            "update-date": "2025-09-09"
          },
          "action-date": "2025-02-13",
          "action-desc": "Introduced in House",
          "summary-text": "<p><strong>More Homes on the Market Act </strong></p><p>This bill increases the amount of gain from the sale of a principal residence that an individual may exclude from gross income (for federal tax purposes). </p><p>Under the bill, an individual may exclude from gross income gain from the sale of a principal residence of up to $500,000 (currently $250,000), and taxpayers who are married and file a joint federal income tax return may exclude up to $1 million (currently $500.000).\u00a0The bill also requires these amounts to be adjusted annually for inflation.</p>"
        },
        "title": "More Homes on the Market Act"
      }
    },
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hr/BILLSUM-119hr1340.xml",
    "summary": {
      "actionDate": "2025-02-13",
      "actionDesc": "Introduced in House",
      "text": "<p><strong>More Homes on the Market Act </strong></p><p>This bill increases the amount of gain from the sale of a principal residence that an individual may exclude from gross income (for federal tax purposes). </p><p>Under the bill, an individual may exclude from gross income gain from the sale of a principal residence of up to $500,000 (currently $250,000), and taxpayers who are married and file a joint federal income tax return may exclude up to $1 million (currently $500.000).\u00a0The bill also requires these amounts to be adjusted annually for inflation.</p>",
      "updateDate": "2025-09-09",
      "versionCode": "id119hr1340"
    },
    "title": "More Homes on the Market Act"
  },
  "summaries": [
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr1340ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "6",
      "updateDate": "2025-03-13T04:20:52Z"
    }
  ]
}
```

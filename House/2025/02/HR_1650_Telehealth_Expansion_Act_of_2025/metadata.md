...
- API URL: https://api.congress.gov/v3/bill/119/hr/1650?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/1650
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/1650",
    "number": "1650",
    "originChamber": "House",
    "policyArea": {
      "name": "Taxation"
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Taxation",
        "updateDate": "2025-05-07T18:23:37Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr1650ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To amend the Internal Revenue Code of 1986 to permanently extend the exemption for telehealth services from certain high deductible health plan rules.",

...
- API URL: https://api.congress.gov/v3/bill/119/hr/1227?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/1227
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/1227",
    "number": "1227",
    "originChamber": "House",
    "policyArea": {
      "name": "Health"
  ...
  "fullTexts": [
    {
      ...
      "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr1227ih.xml",
  ...
  "subjects": [
    {
      "legislativeSubjects": {
        "item": [
          {
            "name": "Drug therapy",
            "updateDate": "2025-06-13T18:47:33Z"
          },
          {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2025-05-07T16:55:24Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hr/BILLSUM-119hr1227.xml",
    "summary": {
      "actionDate": "2025-02-12",
      "actionDesc": "Introduced in House",
      "text": "<p><strong>Alternatives to Prevent Addiction In the Nation Act or the Alternatives to PAIN Act</strong></p><p>This bill reduces\u00a0cost-sharing and prohibits the imposition of certain utilization requirements under the Medicare prescription drug benefit for certain non-opioid pain management drugs.</p><p>Specifically, the bill requires such drugs to be covered without a deductible and to be placed on the lowest cost-sharing tier (if any). The bill also prohibits the imposition of prior authorization requirements (i.e., requiring prior approval from a plan) or step therapy requirements (i.e., requiring the use of alternative drugs before a drug is covered under a plan) with respect to such drugs.</p>",
      "updateDate": "2025-05-21",
      "versionCode": "id119hr1227"
    },
    "title": "Alternatives to PAIN Act"
  },
  "summaries": [
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr1227ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "6",
      "updateDate": "2025-03-12T11:18:36Z"
    }
  ]
}
```

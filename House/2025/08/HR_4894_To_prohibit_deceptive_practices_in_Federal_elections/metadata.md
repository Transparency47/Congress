...
- API URL: https://api.congress.gov/v3/bill/119/hr/4894?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/4894
- Title: Deceptive Practices and Voter Intimidation Prevention Act of 2025
- Congress: 119
- Bill type: HR
- Bill number: 4894
- Origin chamber: House
- Introduced date: 2025-08-05
- Update date: 2026-04-22T22:25:09Z
- Update date including text: 2026-04-22T22:25:09Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/4894",
    "number": "4894",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Deceptive Practices and Voter Intimidation Prevention Act of 2025",
    "type": "HR",
    "updateDate": "2026-04-22T22:25:09Z",
    "updateDateIncludingText": "2026-04-22T22:25:09Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Government Operations and Politics",
        "updateDate": "2025-12-05T21:59:20Z"
      }
    }
  ]
}
      ...
      "item": {
        ...
        "summary": {
          "@attributes": {
            ...
            "summary-id": "id119hr4894v00",
            "update-date": "2026-04-22"
          },
          "action-date": "2025-08-05",
          "action-desc": "Introduced in House",
          "summary-text": "<p><strong>Deceptive Practices and Voter Intimidation Prevention Act of 2025</strong></p><p>This bill generally prohibits deceptive communications and voter interference regarding federal elections.</p><p>Specifically, the bill prohibits any person, within 60 days before a federal election, from communicating, causing to be communicated, or producing for communication certain information on voting, if the person (1) knows such information to be materially false, and (2) has the intent to impede or prevent another person from voting in an election.</p><p>Additionally, the bill prohibits any person, within 60 days before a federal election, from\u00a0using an artificial intelligence system to produce certain information on voting, if the person has the intent to use the system to (1) produce false information, and (2) impede or prevent another person from voting in an election.</p><p>The bill also prohibits hindering, interfering with, or preventing voting or registering to vote.</p><p>A private right of action for preventive relief is established for persons aggrieved by violations of these prohibitions.</p><p>Criminal penalties are also established for violations.</p><p>If the Department of Justice (DOJ) receives a credible report that materially false information has been or is being communicated in violation of the prohibitions on deceptive communications, and state and local election officials have not adequately communicated corrected information, then DOJ must communicate to the public accurate information designed to correct the materially false information.</p><p>The bill extends the prohibition on certain types of intimidation in federal elections to also prohibit intimidation for processing ballots or tabulating, canvassing, or certifying votes.</p>"
        },
        "title": "Deceptive Practices and Voter Intimidation Prevention Act of 2025"
      }
    },
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hr/BILLSUM-119hr4894.xml",
    "summary": {
      "actionDate": "2025-08-05",
      "actionDesc": "Introduced in House",
      "text": "<p><strong>Deceptive Practices and Voter Intimidation Prevention Act of 2025</strong></p><p>This bill generally prohibits deceptive communications and voter interference regarding federal elections.</p><p>Specifically, the bill prohibits any person, within 60 days before a federal election, from communicating, causing to be communicated, or producing for communication certain information on voting, if the person (1) knows such information to be materially false, and (2) has the intent to impede or prevent another person from voting in an election.</p><p>Additionally, the bill prohibits any person, within 60 days before a federal election, from\u00a0using an artificial intelligence system to produce certain information on voting, if the person has the intent to use the system to (1) produce false information, and (2) impede or prevent another person from voting in an election.</p><p>The bill also prohibits hindering, interfering with, or preventing voting or registering to vote.</p><p>A private right of action for preventive relief is established for persons aggrieved by violations of these prohibitions.</p><p>Criminal penalties are also established for violations.</p><p>If the Department of Justice (DOJ) receives a credible report that materially false information has been or is being communicated in violation of the prohibitions on deceptive communications, and state and local election officials have not adequately communicated corrected information, then DOJ must communicate to the public accurate information designed to correct the materially false information.</p><p>The bill extends the prohibition on certain types of intimidation in federal elections to also prohibit intimidation for processing ballots or tabulating, canvassing, or certifying votes.</p>",
      "updateDate": "2026-04-22",
      "versionCode": "id119hr4894"
    },
    "title": "Deceptive Practices and Voter Intimidation Prevention Act of 2025"
  },
  "summaries": [
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr4894ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "6",
      "updateDate": "2025-10-11T06:03:22Z"
    }
  ]
}
```

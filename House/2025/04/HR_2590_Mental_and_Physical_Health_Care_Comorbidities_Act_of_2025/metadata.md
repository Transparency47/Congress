...
- API URL: https://api.congress.gov/v3/bill/119/hr/2590?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/2590
...
- Update date: 2025-12-05T22:03:44Z
- Update date including text: 2025-12-05T22:03:44Z
...
- 2025-04-02 - IntroReferral: Introduced in House
- 2025-04-02 - IntroReferral: Referred to the Committee on Energy and Commerce, and in addition to the Committee on Ways and Means, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-04-02 - IntroReferral: Referred to the Committee on Energy and Commerce, and in addition to the Committee on Ways and Means, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/2590",
    "number": "2590",
    "originChamber": "House",
    "policyArea": {
      "name": "Health"
    ...
    "title": "Mental and Physical Health Care Comorbidities Act of 2025",
    "type": "HR",
    "updateDate": "2025-12-05T22:03:44Z",
    "updateDateIncludingText": "2025-12-05T22:03:44Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2025-04-08T16:36:44Z"
      }
    }
  ]
}
...
```json
{
  "govinfoBulk": {
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hr/BILLSUM-119hr2590.xml",
    "summary": {
      "actionDate": "2025-04-02",
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr2590ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To amend title XVIII of the Social Security Act to establish a demonstration program to promote collaborative treatment of mental and physical health comorbidities under the Medicare program.",

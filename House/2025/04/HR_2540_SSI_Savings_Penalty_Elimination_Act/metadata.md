...
- API URL: https://api.congress.gov/v3/bill/119/hr/2540?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/2540
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/2540",
    "number": "2540",
    "originChamber": "House",
    "policyArea": {
      "name": "Social Welfare"
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Social Welfare",
        "updateDate": "2025-04-08T13:04:26Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr2540ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To amend title XVI of the Social Security Act to update the resource limit for supplemental security income eligibility.",

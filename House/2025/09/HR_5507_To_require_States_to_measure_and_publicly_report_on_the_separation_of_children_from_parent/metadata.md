...
- API URL: https://api.congress.gov/v3/bill/119/hr/5507?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/5507
...
- Update date: 2025-12-05T22:49:36Z
- Update date including text: 2025-12-05T22:49:36Z
...
- 2025-09-19 - IntroReferral: Introduced in House
- 2025-09-19 - IntroReferral: Referred to the House Committee on Ways and Means.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/5507",
    "number": "5507",
    "originChamber": "House",
    "policyArea": {
      "name": "Families"
    ...
    "title": "Hidden Foster Care Transparency Act",
    "type": "HR",
    "updateDate": "2025-12-05T22:49:36Z",
    "updateDateIncludingText": "2025-12-05T22:49:36Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Families",
        "updateDate": "2025-11-18T18:23:43Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr5507ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To require States to measure and publicly report on the separation of children from parents by hidden foster care arrangements, and for other purposes.",

...
- Congress.gov: https://www.congress.gov/bill/119th-congress/house-bill/5288
...
### Introduced in House
- Date: 2025-09-10
- Formatted XML: https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr5288ih.xml
...
### Introduced in House
- Date: 2025-09-10
- Source: https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr5288ih.xml
...
**(i)**
Each location to which the development of, and research relating to, critical artificial intelligence technologies is being offshored.
**(ii)**
Partnerships between domestic entities and foreign entities for such offshore development and research.
**(iii)**
Any reshoring of such offshored development and research.
**(iv)**
The role of foreign nationals who receive in the United States an education or work experience in the development of, and research relating to, such technologies, and subsequently work for foreign entities, including adversaries of the United States, in fields relating to such technologies.
**(v)**
The role of private sector officials and public sector officials who are American and work for such foreign entities.
**(vi)**
The domestic assets, including intellectual property, for such development and research that such foreign entities have acquired, including by means of a bankruptcy or distressed asset sale.
**(vii)**
...
**(viii)**
Any similarities or differences, as the case may be, between the United States and foreign countries in such technologies, including with respect to the following:
**(I)**
...
**(iv)**
Adversaries of the United States, including the Democratic People's Republic of Korea, the Islamic Republic of Iran, the People’s Republic of China, and the Russian Federation, and the proxies of such adversaries.
**(v)**
...
##### (d) Definitions
In this section:
**(1) Critical artificial intelligence technologies**
The term critical artificial intelligence technologies means any hardware, software, or data models relating to artificial intelligence, including the following:
**(A)**
...
Inference stacks.
**(I)**
Data models for any of the following:
**(i)**

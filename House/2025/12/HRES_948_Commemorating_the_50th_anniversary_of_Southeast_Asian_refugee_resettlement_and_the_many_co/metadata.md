...
- API URL: https://api.congress.gov/v3/bill/119/hres/948?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-resolution/948
- Title: Commemorating the 50th anniversary of Southeast Asian refugee resettlement and the many contributions and sacrifices of Southeast Asian Americans to the United States.
- Congress: 119
- Bill type: HRES
- Bill number: 948
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-resolution/948",
    "number": "948",
    "originChamber": "House",
    "policyArea": {
  ...
  "relatedBills": [
    {
      ...
      "latestAction": {
        "actionDate": "2025-12-11",
        "text": "Referred to the Committee on the Judiciary. (text: CR S8676)"
      },
      "number": "542",
      "relationshipDetails": {
        "item": {
      ...
      "title": "A resolution commemorating the 50th anniversary of Southeast Asian refugee resettlement and the many contributions and sacrifices of Southeast Asian Americans to the United States.",
      "type": "SRES"
    }
  ]
}
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "International Affairs",
        "updateDate": "2025-12-12T14:25:22Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hres/BILLS-119hres948ih.xml"
        }
      ],
      "type": "IH"
    }
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "45",
      "updateDate": "2025-12-12T09:08:16Z"
    }
  ]
}
```

...
- API URL: https://api.congress.gov/v3/bill/119/hr/5951?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/5951
...
- Update date: 2025-12-17T09:06:21Z
- Update date including text: 2025-12-17T09:06:21Z
...
- 2025-11-07 - IntroReferral: Introduced in House
- 2025-11-07 - IntroReferral: Referred to the Committee on Armed Services, and in addition to the Committee on Rules, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2025-11-07 - IntroReferral: Referred to the Committee on Armed Services, and in addition to the Committee on Rules, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/5951",
    "number": "5951",
    "originChamber": "House",
    "policyArea": {
      "name": "Congress"
    ...
    "title": "No Nuclear Testing Without Approval Act",
    "type": "HR",
    "updateDate": "2025-12-17T09:06:21Z",
    "updateDateIncludingText": "2025-12-17T09:06:21Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Congress",
        "updateDate": "2025-11-19T12:20:42Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/1/hr/BILLS-119hr5951ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To require the approval of Congress before explosive nuclear testing may be resumed.",

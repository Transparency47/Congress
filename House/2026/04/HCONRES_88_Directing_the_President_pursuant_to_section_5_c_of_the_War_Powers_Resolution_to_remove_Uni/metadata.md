...
- API URL: https://api.congress.gov/v3/bill/119/hconres/88?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-concurrent-resolution/88
...
- Update date: 2026-05-28T21:01:01Z
- Update date including text: 2026-05-28T21:01:01Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-concurrent-resolution/88",
    "number": "88",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Directing the President, pursuant to section 5(c) of the War Powers Resolution, to remove United States Armed Forces from hostilities with Iran.",
    "type": "HCONRES",
    "updateDate": "2026-05-28T21:01:01Z",
    "updateDateIncludingText": "2026-05-28T21:01:01Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "International Affairs",
        "updateDate": "2026-04-24T15:22:17Z"
      }
    }
  ]
}
  ...
  "govinfoBulk": {
    ...
    "payload": {
      ...
      "item": {
        "@attributes": {
          "congress": "119",
          "measure-id": "id119hconres88",
          "measure-number": "88",
          "measure-type": "hconres",
          "orig-publish-date": "2026-04-22",
          "originChamber": "HOUSE",
        ...
        "summary": {
          "@attributes": {
            ...
            "summary-id": "id119hconres88v00",
            "update-date": "2026-04-27"
          },
          "action-date": "2026-04-22",
    ...
    "sourceUrl": "https://www.govinfo.gov/bulkdata/BILLSUM/119/hconres/BILLSUM-119hconres88.xml",
    "summary": {
      "actionDate": "2026-04-22",
      "actionDesc": "Introduced in House",
      "text": "<p>This concurrent resolution directs the President to remove U.S. Armed Forces from hostilities\u00a0against Iran or any part of its government or military unless a declaration of war or authorization to use military force for such purpose has been enacted.</p><p>The resolution specifies that it shall not be construed to prevent the United States from defending itself, its Armed Forces, its diplomatic facilities, or allied states from imminent attack.</p>",
      "updateDate": "2026-04-27",
      "versionCode": "id119hconres88"
    },
    "title": "Directing the President, pursuant to section 5(c) of the War Powers Resolution, to remove United States Armed Forces from hostilities with Iran."
  },
  "summaries": [
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/hconres/BILLS-119hconres88ih.xml"
        }
      ],
      "type": "IH"
    }
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "45",
      "updateDate": "2026-04-23T08:07:25Z"
    }
  ]
}
```

...
- API URL: https://api.congress.gov/v3/bill/119/hres/1216?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-resolution/1216
...
- Update date: 2026-04-30T08:06:26Z
- Update date including text: 2026-04-30T08:06:26Z
...
- 2026-04-27 - IntroReferral: Referred to the Committee on the Judiciary, and in addition to the Committees on House Administration, and Homeland Security, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2026-04-27 - IntroReferral: Referred to the Committee on the Judiciary, and in addition to the Committees on House Administration, and Homeland Security, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2026-04-27 - IntroReferral: Referred to the Committee on the Judiciary, and in addition to the Committees on House Administration, and Homeland Security, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2026-04-27 - IntroReferral: Submitted in House
- Latest action: 2026-04-27: Submitted in House
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-resolution/1216",
    "number": "1216",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Condemning the politically motivated attack on April 25, 2026, at the White House Correspondents' Association Dinner and denouncing political violence.",
    "type": "HRES",
    "updateDate": "2026-04-30T08:06:26Z",
    "updateDateIncludingText": "2026-04-30T08:06:26Z"
  }
}
```
  ...
  "actions": [
    {
      ...
      "text": "Referred to the Committee on the Judiciary, and in addition to the Committees on House Administration, and Homeland Security, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.",
      "type": "IntroReferral"
    },
    {
      "actionCode": "H11100",
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Government Operations and Politics",
        "updateDate": "2026-04-29T20:53:55Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/hres/BILLS-119hres1216ih.xml"
        }
      ],
      "type": "IH"
    }

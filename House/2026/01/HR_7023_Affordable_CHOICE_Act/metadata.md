...
- API URL: https://api.congress.gov/v3/bill/119/hr/7023?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/7023
...
- 2026-01-12 - IntroReferral: Introduced in House
- 2026-01-12 - IntroReferral: Referred to the House Committee on Energy and Commerce.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/7023",
    "number": "7023",
    "originChamber": "House",
    "policyArea": {
      "name": "Health"
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Health",
        "updateDate": "2026-03-13T15:59:47Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/hr/BILLS-119hr7023ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To amend the Patient Protection and Affordable Care Act to establish a public health insurance option, and for other purposes.",

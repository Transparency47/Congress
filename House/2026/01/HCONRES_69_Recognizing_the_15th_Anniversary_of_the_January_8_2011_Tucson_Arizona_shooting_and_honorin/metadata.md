...
- API URL: https://api.congress.gov/v3/bill/119/hconres/69?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-concurrent-resolution/69
...
- Update date: 2026-02-11T23:18:22Z
- Update date including text: 2026-02-11T23:18:22Z
...
- 2026-01-08 - IntroReferral: Referred to the House Committee on Oversight and Government Reform.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-concurrent-resolution/69",
    "number": "69",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Recognizing the 15th Anniversary of the January 8, 2011, Tucson, Arizona, shooting and honoring the survivors, victims, and former Congresswoman Gabby Giffords, a gun violence survivor, and one of the Nation's most influential voices of courage in the fight to end gun violence.",
    "type": "HCONRES",
    "updateDate": "2026-02-11T23:18:22Z",
    "updateDateIncludingText": "2026-02-11T23:18:22Z"
  }
}
```
  ...
  "subjects": [
    {
      "legislativeSubjects": {
        "item": [
          {
            "name": "Arizona",
            "updateDate": "2026-02-06T17:42:02Z"
          },
          {
      ...
      "policyArea": {
        "name": "Crime and Law Enforcement",
        "updateDate": "2026-01-12T16:57:06Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/hconres/BILLS-119hconres69ih.xml"
        }
      ],
      "type": "IH"
    }
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "45",
      "updateDate": "2026-01-09T09:06:40Z"
    }
  ]
}
```

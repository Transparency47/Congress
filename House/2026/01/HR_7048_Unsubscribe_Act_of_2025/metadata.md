...
- API URL: https://api.congress.gov/v3/bill/119/hr/7048?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/7048
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/7048",
    "number": "7048",
    "originChamber": "House",
    "policyArea": {
      "name": "Commerce"
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Commerce",
        "updateDate": "2026-01-14T16:08:48Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/hr/BILLS-119hr7048ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To increase consumer protection with respect to negative options in all media, including on the internet, and for other purposes.",
      "titleType": "Official Title as Introduced",
      "titleTypeCode": "6",
      "updateDate": "2026-01-14T14:03:16Z"
    }
  ]
}
```

...
- API URL: https://api.congress.gov/v3/bill/119/hr/7816?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/7816
- Title: Protect Liberty and End Warrantless Surveillance Act of 2026
- Congress: 119
- Bill type: HR
- Bill number: 7816
- Origin chamber: House
- Introduced date: 2026-03-05
- Update date: 2026-04-29T19:44:27Z
- Update date including text: 2026-04-29T19:44:27Z
...
- 2026-03-05 - IntroReferral: Introduced in House
- 2026-03-05 - IntroReferral: Referred to the Committee on the Judiciary, and in addition to the Committee on Intelligence (Permanent Select), for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
- 2026-03-05 - IntroReferral: Referred to the Committee on the Judiciary, and in addition to the Committee on Intelligence (Permanent Select), for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/7816",
    "number": "7816",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Protect Liberty and End Warrantless Surveillance Act of 2026",
    "type": "HR",
    "updateDate": "2026-04-29T19:44:27Z",
    "updateDateIncludingText": "2026-04-29T19:44:27Z"
  }
}
```
  ...
  "actions": [
    {
      ...
      "text": "Referred to the Committee on the Judiciary, and in addition to the Committee on Intelligence (Permanent Select), for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.",
      "type": "IntroReferral"
    },
    {
      "actionCode": "H11100",
  ...
  "relatedBills": [
    {
      ...
      "latestAction": {
        ...
        "actionTime": "02:08:36",
        "text": "Rule H. Res. 1175 failed passage of House."
      },
      "number": "8035",
      "relationshipDetails": {
        "item": {
      ...
      "title": "To amend the FISA Amendments Act of 2008 to extend the authorities of title VII of the Foreign Intelligence Surveillance Act of 1978 through October 20, 2027, and for other purposes.",
      "type": "HR"
    },
    {
      "congress": "119",
      "latestAction": {
        ...
        "text": "Became Public Law No: 119-84."
      },
      "number": "8322",
      "relationshipDetails": {
        "item": {
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Armed Forces and National Security",
        "updateDate": "2026-04-02T22:22:02Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/hr/BILLS-119hr7816ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To amend the Foreign Intelligence Surveillance Act of 1978 to implement reforms, to amend title 18, United States Code, to prevent law enforcement and intelligence agencies from obtaining certain commercially available information, and for other purposes.",

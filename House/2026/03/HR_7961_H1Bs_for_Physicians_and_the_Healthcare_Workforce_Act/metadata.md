...
- API URL: https://api.congress.gov/v3/bill/119/hr/7961?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-bill/7961
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-bill/7961",
    "number": "7961",
    "originChamber": "House",
    "policyArea": {
      "name": "Immigration"
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "Immigration",
        "updateDate": "2026-04-01T16:42:02Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/hr/BILLS-119hr7961ih.xml"
        }
      ],
...
```json
{
  "titles": [
    ...
    },
    {
      "billTextVersionCode": "IH",
      "billTextVersionName": "Introduced in House",
      "title": "To exempt H-1B health care workers from the restriction under the Presidential Proclamation entitled \"Restriction on Entry of Certain Nonimmigrant Workers\", and for other purposes.",

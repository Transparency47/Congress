...
- API URL: https://api.congress.gov/v3/bill/119/hconres/101?format=json
- Congress.gov URL: https://www.congress.gov/bill/119th-congress/house-concurrent-resolution/101
...
- Update date: 2026-05-28T21:01:16Z
- Update date including text: 2026-05-28T21:01:16Z
...
```json
{
  "bill": {
    ...
    "legislationUrl": "https://www.congress.gov/bill/119th-congress/house-concurrent-resolution/101",
    "number": "101",
    "originChamber": "House",
    "policyArea": {
    ...
    "title": "Directing the President, pursuant to section 5(c) of the War Powers Resolution, to remove United States Armed Forces from hostilities with Iran.",
    "type": "HCONRES",
    "updateDate": "2026-05-28T21:01:16Z",
    "updateDateIncludingText": "2026-05-28T21:01:16Z"
  }
}
```
  ...
  "subjects": [
    {
      ...
      "policyArea": {
        "name": "International Affairs",
        "updateDate": "2026-05-28T20:54:42Z"
      }
    }
  ]
}
  ...
  "textVersions": [
    {
      ...
      "formats": [
        {
          "type": "Formatted XML",
          "url": "https://www.govinfo.gov/bulkdata/BILLS/119/2/hconres/BILLS-119hconres101ih.xml"
        }
      ],
      "type": "IH"
    }
...
```json
{
  "titles": [
    ...
    },
    {
      ...
      "titleTypeCode": "45",
      "updateDate": "2026-05-15T08:07:57Z"
    }
  ]
}
```
